...
public class FibonacciNumberProblem {
	...
	public static int getFibNumSolution1(int n) {
		if (n < 1) {
			return 0;
		}
		if (n == 1 || n == 2) {
	...
	public static int getFibNumSolution2(int n) {
		if (n < 1) {
			return 0;
		}
		if (n == 1 || n == 2) {
	...
	public static int getFibNumSolution3(int n) {
		if (n < 1) {
			return 0;
		}
		if (n == 1 || n == 2) {
		...
		int[][] matrix = { { 1, 1 }, { 1, 0 } };
		int[][] resultMatrix = matrixPow(matrix, n - 2);
