...
public class IsAllUniqueChar {
	...
	public static boolean isUniqueLessTime(String str) {
	...
	public static boolean isUniqueLessSpace(String str) {
		char[] charArr = str.toCharArray();
		heapSort(charArr);
...
//		String str = "123abcd45611";
		String str = "123abcd456";
		System.out.println(isUniqueLessTime(str));
		System.out.println(isUniqueLessSpace(str));
